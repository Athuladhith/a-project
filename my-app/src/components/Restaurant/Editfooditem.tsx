...
const EditFoodItem: React.FC = () => {
  ...
  const fetchFoodItemById = async (foodItemId: string) => {
    try {
      const response = await Api.get(`http://localhost:5000/api/restaurant/fetchfoodItems/${foodItemId}`);
  ...
  const fetchCategories = async () => {
    try {
      const response = await Api.get('http://localhost:5000/api/restaurant/categories');
  ...
  const fetchCuisines = async () => {
    try {
      const response = await Api.get('http://localhost:5000/api/restaurant/cuisine');
  ...
  const handleUpdateFoodItem = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const rep=await Api.put(`http://localhost:5000/api/restaurant/updatefoodItems/${id}`, formData);
