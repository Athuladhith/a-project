  ...
  const handlePlaceOrder = async () => {
    ...
    try {
        ...
        if (window.Razorpay) {
          ...
          const options = {
            ...
            handler: async (response: any) => {
              ...
              await clearCart();
              navigate('/orderplaced', { state: { paymentId: response.razorpay_payment_id, paymentMethod: 'razorpay' } });
            },
            prefill: {
              name: 'Customer Name',
      ...
      paymentId: payid
        ...
        navigate('/orderplaced', { state: { orderId: orderId, paymentMethod: 'cod',paymentId:payid } });
      } else {
